...
[![Build Status](https://travis-ci.org/bgruening/docker-galaxy-protease-prediction.svg?branch=master)](https://travis-ci.org/bgruening/docker-galaxy-protease-prediction)

# docker-galaxy-protease-prediction

The [Galaxy](http://www.galaxyproject.org) [Docker](http://www.docker.io) Image is an easy distributable full-fledged Galaxy installation, that can be used for testing, teaching and presenting new tools and features. This flavour includes a tool for protease predictions based on different cleavage sites.
